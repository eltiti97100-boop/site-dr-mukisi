...
export default function DownloadRequestModal({ isOpen, onClose }: DownloadRequestModalProps) {
        ...
        <DialogContent className="sm:max-w-md">
          <div className="text-center py-8">
            ...
            <p className="text-slate-600">
              Nous examinerons votre demande et vous contacterons dans les 48h pour vous fournir les liens de
              téléchargement.
            </p>
          </div>
        </DialogContent>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <Alert>
          ...
          <AlertDescription>
            L'application mobile DermatoPro est réservée aux professionnels de santé certifiés. Votre demande sera
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Précisez votre demande ou vos besoins spécifiques..."
              rows={3}
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <label htmlFor="newsletter" className="text-sm text-slate-600">
                Je souhaite recevoir les actualités et mises à jour de DermatoPro
              </label>
            </div>
          </div>
